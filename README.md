...
[![Live Deployment](https://img.shields.io/badge/Deployment-Live%20Preview-8b5cf6?style=for-the-badge)](/preview/prod-derivatives-exchange-cb0aab/)
...
- **پیوند دسترسی زنده (Live Preview):** [/preview/prod-derivatives-exchange-cb0aab/](/preview/prod-derivatives-exchange-cb0aab/)
...
```bash
# ۱. کلون ریپازیتوری
git clone https://github.com/98H/nexus-derivatives-exchange.git
cd nexus-derivatives-exchange
...
- **تاریخ آخرین همگام‌سازی:** 2026-09-19 16:15:58 UTC